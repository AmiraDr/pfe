  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Réserver un materiel</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Réserver un Materiel</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="POST" action="{{route('adminReserverMaterielPost')}}">
                @csrf
                <div class="card-body">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-success" >Reserver un materiel</button>
