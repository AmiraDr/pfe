  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Supprimer un Materiel</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Supprimer un Materiel</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="POST" action="{{route('agentDeleteMaterielPost')}}">
                @csrf
                <input type="hidden" name="id" value="{{$materiel->id}}" />
                <div class="card-body">
                  
                    <h2 class="text-danger text-center">Etês vous sure de vouloir supprimer le Materiel : {{$materiel->nom}} ?</h2>
