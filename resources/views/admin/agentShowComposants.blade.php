          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                  <a href="{{route('agentAddComposant')}}" class="btn btn-success btn-sm"> <i class="fas fa-plus"></i> Ajouter un Composant </a>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach ($composants as $composant)
                    <tr>
                      ...
                      <td>
                        <a href="{{route('agentShowComposant',$composant->id)}}" class="btn btn-info btn-sm"> Détails <i class="fas fa-add"></i> </a>
